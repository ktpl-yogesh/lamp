...
RUN apt-get update && apt-get install -y sudo \
    ...
    && apt-get -y install libapache2-mod-php5 php5 php5-mysql \
    && apt-get -y install php5-common php5-gd php5-mysql php5-mcrypt php5-curl php5-intl php5-xsl \    
    && cd / \
...
ADD tools/docker/php5/apache2/php.ini /etc/php/5.5/apache2/php.ini
ADD tools/docker/php5/cli/php.ini /etc/php/5.5/cli/php.ini
